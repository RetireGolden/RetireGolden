...
| `plannerContentRoutes` | `examples`, `learn/*`, `sources` (redirects to `learn/sources`), `disclaimer`, `how-tested` | Storage-independent content; workspace pages link into it, so mount it (or redirect those paths) |
