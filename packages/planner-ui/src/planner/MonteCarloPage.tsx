          ...
          <div className="chart-card">
            ...
            {visibleFrontier ? (
              <div className="chart-grid">
                <div>
                  ...
                  <div className="chart-frame" style={frameH(240)} role="figure" aria-label="Spending versus success: success rate by annual spending level">
                    <ResponsiveContainer width="100%" height="100%">
                ...
                <div>
                  ...
                  <div className="chart-frame" style={frameH(240)} role="figure" aria-label="Retirement age versus success: success rate by retirement age">
                    <ResponsiveContainer width="100%" height="100%">
                      <ComposedChart data={visibleFrontier.retirement} margin={{ left: 12, right: 8, top: 8 }}>
                        ...
                        <Tooltip
                          ...
                          labelFormatter={(v) => `Retirement age ${typeof v === 'number' || typeof v === 'string' ? v : ''}`}
                          contentStyle={chartTooltipStyle}
                        />
            ...
            {visibleFrontier && visibleFrontier.annuitization.points.length > 1 ? (
              <div style={{ marginTop: '1rem' }}>
                ...
                <div className="chart-grid">
                  <div>
                    <div className="chart-frame" style={frameH(240)} role="figure" aria-label="Annuitization: success rate by share of the portfolio annuitized">
                      <ResponsiveContainer width="100%" height="100%">
                        <ComposedChart
                        ...
                        >
                          ...
                          <Tooltip
                            ...
                            labelFormatter={(v) => `${typeof v === 'number' || typeof v === 'string' ? v : ''}% annuitized`}
                            contentStyle={chartTooltipStyle}
                          />
