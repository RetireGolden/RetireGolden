...
export const EXAMPLE_PLANS: ExamplePlan[] = [
  ...
  // A-B decision pairs (same engine features both sides; the savings strategy is the variable)
  {
    ...
    lookFor: 'Early-withdrawal penalties in Results once cash and the small brokerage run dry, marketplace premiums jumping when current-year MAGI clears the ACA cliff, and materially earlier depletion than the bridge version.',
