...
function FireLens({
  ...
  return (
    <>
      ...
      <div className="chart-frame" style={frameH(320)} role="figure" aria-label="Path to financial independence: investable balance against the independence target, by year">
  ...
  return (
    <section>
      ...
      <div className="chart-card">
        ...
        <div className="chart-frame" style={frameH(320)} role="figure" aria-label="Investable balances by account type, by year">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart
              data={rows}
              margin={{ left: 12, right: 8, top: 8 }}
      ...
      <div className="chart-card">
        ...
        <div className="chart-frame" style={frameH(280)} role="figure" aria-label="Income versus spending, by year">
          <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="chart-card">
        ...
        <div className="chart-frame" style={frameH(280)} role="figure" aria-label="Income by source, by year">
          <ResponsiveContainer width="100%" height="100%">
      ...
      <div className="chart-card">
        ...
        <div className="chart-frame" style={frameH(280)} role="figure" aria-label="Spending by category, by year">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart
              data={expenseRows}
              margin={{ left: 12, right: 8, top: 8 }}
      ...
      <div className="chart-card">
        ...
        <div className="chart-frame" style={frameH(280)} role="figure" aria-label="Tax and MAGI, by year">
          <ResponsiveContainer width="100%" height="100%">
