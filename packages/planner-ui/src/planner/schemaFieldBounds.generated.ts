...
export const SCHEMA_FIELD_BOUNDS: Record<string, SchemaBounds> = {
  'accounts.N.allocation.endYear': { min: 1900, max: 2200 },
  'accounts.N.allocation.stages.N.fromYear': { min: 1900, max: 2200 },
  'accounts.N.allocation.startYear': { min: 1900, max: 2200 },
  'accounts.N.allocation.targets.N.year': { min: 1900, max: 2200 },
  ...
  'accounts.N.contributionSchedule.N.fromAge': { min: 0, max: 100 },
  'accounts.N.contributionSchedule.N.toAge': { min: 0, max: 100 },
  'accounts.N.costBasis': { min: 0 },
  'accounts.N.dividendYieldPct': { min: 0 },
  'accounts.N.estateBeneficiary.charityPct': { min: 0, max: 100 },
  'accounts.N.hecm.openYear': { min: 1900, max: 2200 },
  ...
  'accounts.N.purchase.year': { min: 1900, max: 2200 },
  'accounts.N.qualifiedRatio': { min: 0, max: 1 },
  'accounts.N.sepp.startAge': { min: 40, max: 59 },
  ...
  'expenses.oneTimeGoals.N.minFundingPct': { min: 0, max: 100 },
  ...
  'expenses.spendingPolicy.abw.bondRealYieldPct': { min: -2, max: 8 },
  'expenses.spendingPolicy.abw.equitySharePct': { min: 0, max: 100 },
  'expenses.spendingPolicy.abw.fixedRealReturnPct': { min: -5, max: 12 },
  'expenses.spendingPolicy.abw.startingCape': { min: 5, max: 60 },
  'expenses.spendingPolicy.abw.tiltPct': { min: -5, max: 5 },
  ...
  'expenses.survivorSpendingPct': { min: 0, max: 100 },
  ...
  'incomes.N.formerSpouses.N.deceasedClaimAge.months': { min: 0, max: 11 },
  'incomes.N.formerSpouses.N.deceasedClaimAge.years': { min: 62, max: 70 },
  'incomes.N.formerSpouses.N.marriageYears': { min: 0 },
  'incomes.N.formerSpouses.N.remarriedAtAge': { min: 0, max: 120 },
  ...
  'insurance.N.benefitPeriodYears': { exclusiveMin: 0 },
  ...
  'insurance.N.eliminationPeriodDays': { min: 0, max: 365 },
