  ...
  blocks: [
    ...
    { type: 'heading', text: 'Quick takeaways' },
    {
      ...
      items: [
        ...
        'The flow prefills income streams, filing status, state, and the MAGI that Medicare\'s IRMAA surcharge looks back at. Everything it fills is labeled "from your 1040" on the review checklist and stays editable.',
