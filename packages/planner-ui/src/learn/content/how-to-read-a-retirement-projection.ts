...
export const howToReadProjectionArticle: LearningArticle = {
  ...
  blocks: [
    ...
    {
      type: 'prose',
      md: 'On Results, each year row has a **View flow** button. It opens a source-to-use picture of that year: a diagram plus a table of every line. One view is cash the household could spend. The other is transfers between accounts. Amounts follow the same today\'s-dollars / nominal-dollars toggle as the rest of the page.',
    },
    {
      type: 'prose',
