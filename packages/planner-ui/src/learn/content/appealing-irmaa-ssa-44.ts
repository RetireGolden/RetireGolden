...
export const blocks: ArticleBlock[] = [
  ...
  { type: 'heading', text: 'Quick takeaways' },
  {
    ...
    items: [
      ...
      'After a qualifying life-changing event, Form SSA-44 lets you request a redetermination based on the current year\'s estimated income. The request can only help: if your estimate is not lower, Social Security keeps the normal determination.',
  ...
  { type: 'heading', text: 'Common mistakes' },
  {
    ...
    items: [
      ...
      "Treating a Roth conversion as a qualifying event. Only the eight listed life-changing events qualify, and a conversion that raised MAGI doesn't.",
    ],
  },
