...
export const blocks: ArticleBlock[] = [
  ...
  },
  {
    ...
    items: [
      ...
      '**The base is the deceased\u2019s actual benefit.** If the deceased delayed past FRA, those delayed retirement credits pass through to the survivor. If the deceased died before claiming, the benefit is the one earned by the death: no early reduction, and only the delayed credits earned by then, with survivor benefits available from the month of death. RetireGolden works in whole years, so it starts the survivor benefit in the year after the death.',
    ],
  },
  {
    type: 'callout',
