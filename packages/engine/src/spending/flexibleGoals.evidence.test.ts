...
describeCalculation('flexible-goal-scheduling', {
  example: {
    inputs: { cost: 1000, inflFactor: 1.10, availableBudget: 700, minFundingPct: 50, allowPartialFunding: true },
    expected: { outcome: 'partiallyFunded', amountNominal: 1100, fundedNominal: 700, unfundedNominal: 400, remainingBudget: 0 },
    tolerance: 'exact',
  },
