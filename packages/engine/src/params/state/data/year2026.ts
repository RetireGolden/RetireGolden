...
const rawStateYear2026 = {
  ...
  states: {
    ...
    MS: {
      ...
      // 27-7-5(1)(b)(ii) sets the rate ABOVE the $10,000 zero band at 4% for
      // 2026 (subparagraph 3), 3.75% for 2027 (4), 3.5% for 2028 (5), 3.25%
      // for 2029 (6) and 3% from 2030 (7). 2027 onward and the self-repeal
      // sentence came from the Build Up Mississippi Act (2025 H.B. 1),
