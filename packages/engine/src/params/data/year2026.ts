...
export const year2026: ParameterPack = {
  ...
  rmd: {
    ...
    // Single Life Table, Treas. Reg. 1.401(a)(9)-9(b) Table 1 to Paragraph (b),
    // transcribed entry for entry from the eCFR text of the section. Ages 0
    // through 119 are the table's own rows; the 120 entry is its "120 and
    // over" row. Unisex, like every table under 1.401(a)(9)-9, and fixed by
    // regulation rather than indexed, so it moves only when Treasury amends
    // the section.
    // Source: https://www.ecfr.gov/current/title-26/section-1.401(a)(9)-9
    singleLifeTable: {
      ...
      78: 12.6, 79: 11.9, 80: 11.2, 81: 10.5, 82: 9.9, 83: 9.3, 84: 8.7, 85: 8.1,
      86: 7.6, 87: 7.1, 88: 6.6, 89: 6.1, 90: 5.7, 91: 5.3, 92: 4.9, 93: 4.6,
      94: 4.3, 95: 4.0, 96: 3.7, 97: 3.4, 98: 3.2, 99: 3.0, 100: 2.8, 101: 2.6,
