 ...
 * accepted tax, penalty, cash-inflow, convergence, and residual values. Those
 * values are observed at independent ledger and warning boundaries, so an
...
describe('simulatePlan annual funding fixed-point delegation', () => {
  it('commits the coordinator-selected evaluation, cash inflow, and diagnostics', () => {
    ...
    expect(year.balances.cash).toBe(555)
