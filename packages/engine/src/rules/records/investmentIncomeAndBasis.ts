...
export const investmentIncomeAndBasisRecords = {
  ...
  'irc-1411-d-modified-agi-foreign-exclusion-addback': {
    ...
    statement:
      'When separately characterized amounts are supplied, the federal calculator uses the broad foreign-exclusion addback for the section 151 senior-deduction modified-AGI calculation and the section 1411-specific net addback for the NIIT threshold leg. If the calculator\'s optional NIIT-specific input is omitted, its documented compatibility approximation reuses the broad amount. The calculator accepts those amounts as inputs; it does not determine eligibility for exclusions under sections 911, 931, or 933 or deductions allocable under section 911(d)(6).',
    classification: 'approximated',
    contraryReading: null,
    errorDirection: 'overstatesTax',
    conventionRationale:
