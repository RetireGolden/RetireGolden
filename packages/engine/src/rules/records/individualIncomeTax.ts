...
export const individualIncomeTaxRecords = {
  ...
  'irc-1-j-3-B-rate-tables-adjusted-each-year': {
    ...
    authority: [{
      ...
      kind: 'statute',
      citation: 'IRC 55(d)(3)(A)-(C)',
      url: 'https://uscode.house.gov/view.xhtml?req=granuleid:USC-prelim-title26-section55&num=0&edition=prelim',
      quotedText:
        '(3) Inflation adjustment (A) In general In the case of any taxable year beginning in a calendar year after 2012, the amounts described in subparagraph (B) shall each be increased by an amount equal to- (i) such dollar amount, multiplied by (ii) the cost-of-living adjustment determined under section 1(f)(3) for the calendar year in which the taxable year begins, determined by substituting "calendar year 2011" for "calendar year 2016" in subparagraph (A)(ii) thereof. (B) Amounts described The amounts described in this subparagraph are- (i) each of the dollar amounts contained in subsection (b)(1)(A), (ii) each of the dollar amounts contained in subparagraphs (A), (B), and (D) of paragraph (1), and (iii) each of the dollar amounts in subparagraphs (A) and (B) of paragraph (2). (C) Rounding Any increased amount determined under subparagraph (A) shall be rounded to the nearest multiple of $100.',
    }, {
      kind: 'statute',
