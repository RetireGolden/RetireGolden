...
export const paramsAttestations: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'params/state/data/year2026.ts': Object.freeze({ status: 'partial', sweptOn: '2026-09-05', note: 'existing law records name this pack; residuals include KY aggregate MFJ deduction convention without spouse-allocation record, IA minimum-income/alternate and enhanced-senior conformity omissions, DC August emergency statutory-conformity timing unresolved, and ME phase-out/personal exemption still unmodeled' }),
  ...
  'params/state/types.ts': Object.freeze({ status: 'registered', sweptOn: '2026-09-05', note: 'types only; named by records for the shapes they define, including standardDeductionAge65AdditionConformity' }),
