...
export const paramsAttestations: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'params/state/data/year2026.ts': Object.freeze({ status: 'partial', sweptOn: '2026-09-05', note: 'existing law records name this pack; residuals include KY aggregate MFJ deduction convention without spouse-allocation record, IA minimum-income/alternate and enhanced-senior conformity omissions, DC August emergency statutory-conformity timing unresolved, ME modeled Maine-AGI proxy / personal exemption / blindness / part-year month approximation, and non-ME gaps unchanged' }),
