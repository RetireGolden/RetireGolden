...
export const socialSecurityAttestations: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'socialSecurity/currentSpouseBenefit.ts': Object.freeze({ status: 'registered', sweptOn: '2026-09-06', note: 'the sole exported function is the fail-closed enforcer named by usc-42-402-q-3-B-k-3-A-current-spouse-dual-entitlement. It owns the complete ordinary early current-spouse product guard, strict unclamped configured-date ordering, and reduced-own-plus-reduced-excess components; it returns null outside that record and does not establish eligibility or payment history' }),
