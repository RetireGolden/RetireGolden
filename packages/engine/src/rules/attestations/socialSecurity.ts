...
export const socialSecurityAttestations: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'socialSecurity/maritalBenefits.ts': Object.freeze({ status: 'partial', sweptOn: '2026-09-09', note: 'Living-divorced, ordinary-widow, and surviving-divorced duration eligibility gates, plus half-PIA and survivor pricing, are named on this file. Residual: claimant-has-claimed timing (claimantAge vs claimAge) is an engine convention with no record; survivor amount assembly is delegated to already-registered survivorBenefit.ts/claimFactor.ts/nra.ts without a borrowed pin here' }),
