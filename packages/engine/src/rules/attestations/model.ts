...
export const modelAttestations: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'model/retirementActionAnnualTaxFacts.ts': Object.freeze({ status: 'partial', sweptOn: '2026-09-04', note: 'ordinary April filing calendar delegated to tax/ordinaryFederalFilingDeadline.ts; persisted prior-year contribution-window and opening-basis/completeness invariants still enforced here without matching function pins' }),
})
