...
export const testingAttestations: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'testing/ownedNonRothIraPostCandidateFixture.test-support.ts': Object.freeze({ status: 'rule-free', sweptOn: '2026-09-08', note: 'canonical post-candidate classification input builder shared by ownedNonRothIraAnnualPostCandidateEvidence.test.ts and ordinaryFederalFilingDeadline.test.ts; *.test-support.ts excludes this from dist so it is not published' }),
})
