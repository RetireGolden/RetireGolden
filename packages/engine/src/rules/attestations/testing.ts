...
export const testingAttestations: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'testing/ownedNonRothIraPostCandidateFixture.ts': Object.freeze({ status: 'rule-free', sweptOn: '2026-09-08', note: 'canonical post-candidate classification input builder shared by ownedNonRothIraAnnualPostCandidateEvidence and filing-evidence describeRule tests; fixture-only with no operative tax-law pin' }),
})
