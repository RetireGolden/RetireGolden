...
export const insightsAttestations: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'insights/detectors/ssClaimMilestone.ts': Object.freeze({ status: 'partial', sweptOn: '2026-09-05', note: 'former-spouse eligibility delegates to registered bestMaritalBenefit; claim-factor, payable-month, and family-max are delegated. Statutory half-PIA numerical base (0.5 * PIA * spousalBenefitFactor) in the current-spouse prior-year comparator is now covered on usc-42-402-b-2-spousal-half-of-pia. Residuals: pre-horizon payable-month reconstruction, gate-stream selection, own/former/current winner ordering and family-maximum composition, enabling-event timing, and missing-PIA fallback' }),
