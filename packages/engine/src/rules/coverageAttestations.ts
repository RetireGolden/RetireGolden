...
export const COVERAGE_ATTESTATIONS: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'projection/internal/fixedAssetDispositions.ts': Object.freeze({ status: 'rule-free', sweptOn: '2026-08-31', note: 'the fixed-asset disposition phase, lifted verbatim out of simulatePlan; it orchestrates which property accounts sell and how a HECM on the sold home is repaid, and calls tax/propertySale.ts#propertySaleTax for the pricing — the §121 exclusion and depreciation-recapture claims stay registered against that file, which is where the arithmetic lives' }),
