...
export const COVERAGE_ATTESTATIONS: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'actions/retirementActionCandidateIdentityAllocator.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'Conversion source/destination vehicle restrictions and QCD source-IRA restrictions; no record' }),
  'actions/retirementActionManualReview.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'Replacement source-owner and Roth-destination eligibility checks; no record' }),
  'actions/rothConversionExecution.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-25', note: 'Positive-basis deferred character and direct conversion vehicle gates; no record' }),
  ...
  'decisions/generators.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: 'QLAC 85 ceiling registered via treas-reg-1-401-a-9-6-q-1-ii-qlac-commences-by-the-85th-birthday naming annuityPurchaseGenerator; the bracket-target list and the 62-70 claim grid are candidate search-space choices, not statutory claims' }),
  ...
  'decisions/rothConversionCandidateAdapter.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'Same-owner Roth destination/date gate; no record' }),
  ...
  'insights/detectors/missingDataBasis.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: 'the section 121 coverage classification is registered via irc-121-a-b-principal-residence-eligibility-tests naming this detector; it remains a second implementation of the cap arithmetic beside tax/propertySale.ts, a consolidation candidate' }),
  ...
  'projection/flatTax.ts': Object.freeze({ status: 'rule-free', sweptOn: '2026-08-29', note: 'V1 placeholder whose only importers are test files; the 85 percent constant never reaches a user-facing number, and the docblock forbids adding precision - same footing as the testing/ fixtures' }),
  ...
  'rmd/applicableAge.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-29', note: 'SECURE 2.0 applicable ages/RBD April-1; born-1959 dual-age contest; 70½ cohort & July-1949 cut. Correction: treas-reg-1-401-a-9-5-d-1-ii and the applicable-age records DO name this file; residual is the RBD April-1 arm and the pre-SECURE cohorts' }),
