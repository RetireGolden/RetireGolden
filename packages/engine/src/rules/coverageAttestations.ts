...
export const COVERAGE_ATTESTATIONS: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'actions/annualQcdDerivedTaxCharacter.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: 'Owned-source eligibility is typed into AcceptedQcdSourceEligibilityEvidence and registered under the 408(d)(8) source records that name this file; the taxable/excludable/basis partition is registered under the QCD composition-order and taxable-first records' }),
  ...
  'actions/annualQcdPhysicalExecution.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: 'The owned, non-inherited IRA pool restriction is enforced at the account gate and registered under the 408(d)(8) source records (beneficiary, Roth, ongoing SEP/SIMPLE), which now name the stager' }),
  ...
  'actions/ownedNonRothIraAnnualCandidateTransaction.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-29', note: 'Owned traditional/SEP/SIMPLE IRA source scope remains unregistered; line-7 staging is registered where it is enforced (the movement stager), and this wrapper enforces no line semantics itself' }),
  'actions/ownedNonRothIraAnnualFilingEvidence.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-29', note: 'Prior-year contribution window covered; the January-1 opening-basis requirement is an engine convention (408(d)(2)(C) computes values as of the close of the year, so the calendar anchor here is architecture, not statute) and stays unregistered, as does the owner-wide non-inherited pool scope' }),
  'actions/ownedNonRothIraAnnualFilingSourceResolver.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-29', note: 'Filing source restricted to owned non-inherited traditional IRA pool; the scope claim has no record' }),
  ...
  'actions/ownedNonRothIraAnnualPlanCoordinator.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-29', note: 'Owner-wide pool excludes inherited IRAs; Form 8606 numerator/denominator and line-7/line-8 stacking; exact age-59½ threshold; no record' }),
  'actions/ownedNonRothIraAnnualPostCandidateEvidence.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-29', note: 'Contribution window covered; Form 8606 lines 1/4/6/7/9, owner-wide pool, and explicit zero line 8; no record' }),
  'actions/ownedNonRothIraMovementCandidate.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-29', note: 'Line-7 staging of executed owned-IRA withdrawals registered under form-8606-line-7-owned-ira-movement-staging; the owned traditional/SEP/SIMPLE source-scope claim remains unregistered' }),
  ...
  'insights/detectors/missingDataBasis.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: 'Roth 59½ gate registered under irc-408A-d-2-roth-qualified-distribution, which now names the detector alongside the basis records that motivated it' }),
  ...
  'ladder/bridge.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-29', note: 'The age-62 floor the bridge sizes against is registered under usc-42-402-worker-claim-window-62-to-70 at the claim-factor that enforces it; this file consumes the floor and the PIA sizing as contracts rather than enforcing them, and stays partial on that consumption' }),
  ...
  'params/index.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-29', note: 'The C-CPI-U-vs-plan-inflation indexing liberty is stated in the records naming indexFederalTaxPack; the Trustees default SS haircut (2034, 17%) remains unregistered because its source is the 2026 Trustees Report, which is owner-staged and not yet fetchable' }),
  ...
  'tax/propertySale.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: 'Section 121/1250 records name this file and the personal-use loss floor is now registered under irc-165-c-personal-use-sale-loss-nondeductible' }),
