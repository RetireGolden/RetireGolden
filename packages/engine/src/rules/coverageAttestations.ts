...
export const COVERAGE_ATTESTATIONS: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'projection/internal/tipsLadderAnnualCashFlow.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-30', note: 'the TIPS-ladder annual cash-flow phase, lifted verbatim out of simulatePlan; carries the positive-inflation-adjustment OID claim and the deflation clamp registered at treas-reg-1-1275-7-d-4-positive-inflation-adjustment-oid and treas-reg-1-1275-7-f-1-deflation-adjustment-income' }),
