...
export const COVERAGE_ATTESTATIONS: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'actions/ownedNonRothIraAnnualCandidateTransaction.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: null }),
  'actions/ownedNonRothIraAnnualFilingEvidence.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: null }),
  'actions/ownedNonRothIraAnnualFilingSourceResolver.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: null }),
  'actions/ownedNonRothIraAnnualFinalization.ts': Object.freeze({ status: 'rule-free', sweptOn: '2026-08-24', note: null }),
  'actions/ownedNonRothIraAnnualPhysicalTransaction.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: null }),
  'actions/ownedNonRothIraAnnualPlanCoordinator.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-29', note: 'Exact age-59½ threshold remains in the penalty cluster' }),
  'actions/ownedNonRothIraAnnualPostCandidateEvidence.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: null }),
  'actions/ownedNonRothIraMovementCandidate.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: null }),
  ...
  'internal/ownedNonRothIraAnnualAttemptSettlement.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: null }),
  ...
  'internal/ownedNonRothIraRuntimeSourceSeries.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: null }),
  ...
  'projection/annualCashFlowCapture.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: null }),
  ...
  'projection/ownedIraAnnualPhysicalTransactionInputs.ts': Object.freeze({ status: 'registered', sweptOn: '2026-08-29', note: null }),
