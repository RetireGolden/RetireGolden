...
export const COVERAGE_ATTESTATIONS: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'actions/annualQcdActionExecutionEvidence.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'QCD direct-transfer penalty marked not applicable; no record' }),
  'actions/annualQcdDeductionTreatmentCoordinator.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: '§408(d)(8)(E) excluded-QCD §170 deduction gate; no record' }),
  'actions/annualQcdDerivedTaxCharacter.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'SEP/SIMPLE and owned-source eligibility gates; no record; QCD taxable/excludable/basis partition; no record' }),
  ...
  'actions/annualQcdResidualForm8606.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'Non-QCD QCD remainder/Form 8606 line-7 basis-return treatment; no record; residual line-7/line-8 pro-rata reconciliation; no record' }),
  ...
  'actions/beneficiaryTraditionalIraAnnualSimulatorDelta.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'Death-beneficiary 0% early-distribution penalty; no record' }),
  'actions/beneficiaryTraditionalIraDeathPenalty.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'Death-beneficiary 0% early-distribution penalty; no record' }),
  ...
  'actions/contract.ts': Object.freeze({ status: 'rule-free', sweptOn: '2026-08-24', note: null }),
  ...
  'actions/execution.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'Equity compensation fully ordinary-income at execution; non-retirement penalty marked inapplicable; no record' }),
  ...
  'actions/planBalanceAdapter.ts': Object.freeze({ status: 'rule-free', sweptOn: '2026-08-24', note: null }),
  ...
  'actions/rothConversionExecution.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'RMD aggregation/order covered; zero-basis taxable vs positive-basis deferred character and direct conversion vehicle gates; no record' }),
  ...
  'ladder/ladderMath.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'Statutory TIPS min coupon 0.125%; par-yield ladder pricing conventions; no naming record' }),
  ...
  'params/state/types.ts': Object.freeze({ status: 'rule-free', sweptOn: '2026-08-24', note: 'types only; named by records for shape definitions' }),
  'params/types.ts': Object.freeze({ status: 'rule-free', sweptOn: '2026-08-24', note: 'types only; named by records for shape definitions' }),
  ...
  'socialSecurity/claimFactor.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'worker claim-age window and factor composition rest on records naming benefitFactor.ts; no record names this file' }),
  'socialSecurity/disability.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'SGA amount registered; SSDI benefit=full PIA; FRA conversion window; annual SGA×12 suspension proxy not registered here' }),
  ...
  'socialSecurity/nra.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'Survivor FRA schedule (65→66y8m) has no record naming this file' }),
  'socialSecurity/piaFromEarnings.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-24', note: 'AIME pipeline (age 22–61 window, 5 lowest dropped, top-35 years, AWI indexing) not separately registered' }),
