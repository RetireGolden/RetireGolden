...
export const COVERAGE_ATTESTATIONS: Readonly<Record<string, CoverageAttestation>> = Object.freeze({
  ...
  'actions/ownedNonRothIraAnnualCandidateTransaction.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-29', note: 'The owned source scope is registered under irc-408-d-2-A-owner-wide-non-inherited-ira-pool at the movement stager whose gate enforces it; this wrapper enforces neither the scope nor any line semantics itself and no record names it' }),
  'actions/ownedNonRothIraAnnualFilingEvidence.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-29', note: 'Prior-year contribution window covered; the owner-wide non-inherited pool scope is registered under irc-408-d-2-A-owner-wide-non-inherited-ira-pool at the gates that enforce it; the January-1 opening-basis anchor stays an engine convention (408(d)(2)(C) computes values as of the close of the year)' }),
  'actions/ownedNonRothIraAnnualFilingSourceResolver.ts': Object.freeze({ status: 'partial', sweptOn: '2026-08-29', note: 'The owned non-inherited pool restriction arrives through schema claims; enforcement and registration live at the pool-scope record\'s pinned gates, and this resolver\'s own issues are binding and dedup integrity with no separate statutory claim' }),
