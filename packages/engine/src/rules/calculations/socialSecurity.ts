...
export const socialSecurityRecords = {
  ...
  'survivor-benefit-rib-lim': {
    ...
    limits: [
      ...
      'For a worker who dies before 62, the projection uses the PIA as entered; the law computes that PIA with the death as the eligibility event (20 CFR 404.211 and 404.212) and, for a survivor, can raise it by indexing the worker\'s earnings to a later year (42 U.S.C. 402(e)(2)(B)), which is not modeled',
      'For a former spouse who died, the survivor base is priced at the claim age entered for that person, or at full retirement age when none is entered; for a former spouse who died after full retirement age without claiming, entering the age in years and months in the month of death counts the credits earned by then, while a whole-year age drops the months since the last birthday',
