...
export const socialSecurityRecords = {
  ...
  'survivor-benefit-rib-lim': {
    ...
    limits: [
      ...
      'For a former spouse who died, the survivor base is priced at the claim age entered for that person, or at full retirement age when none is entered; for a former spouse who died after full retirement age without claiming, entering the age in the month of death counts the credits earned by then',
