...
export const medicareAndAcaRecords = {
  ...
  'aca-enrollment-and-applicable-slcsp-premium-annual': {
    ...
    formula: {
      ...
      variables: [
        { symbol: 'E_i,m', meaning: 'Covered member i\'s enrollment premium in month m', unit: 'usd/month', domain: 'nonnegative' },
        { symbol: 'B_i,m', meaning: 'Covered member i\'s SLCSP benchmark premium in month m', unit: 'usd/month', domain: 'nonnegative' },
      ],
      timing: 'annual, from the year\'s 12 monthly quotes',
      rounding: 'none',
    },
    justification: {
      kind: 'derivation',
  ...
  'spending-healthcare-annual': {
    title: 'Annual healthcare expense: Medicare, extras and marketplace premiums',
    purpose: 'Everything the projection charges the household for health coverage in one year.',
    kind: 'composition',
    ...
    formula: {
      ...
      timing: 'annual; the Medicare tier reads the two-year lookback MAGI',
      rounding: 'none',
    },
    justification: {
      kind: 'derivation',
