 ...
 * and `scripts/equivalence/specs/simulate-aggregate-roth-conversion-target-boundary.json`
 * are the
 ...
 * `AD`, `AF`, `AG`, and `AH` only as reach-entry namespaces. Block AE pins the otherwise-cold
