 ...
 *   AO annual optimizer-probe publication
 *
 ...
 * AI, AJ, AK, AL, AM, AN and AO, each have a phase-specific reach spec beside the earlier
 * batch instruments.
 *
 ...
 * `scripts/equivalence/specs/simulate-aca-result-publication-boundary.json`,
 * and `scripts/equivalence/specs/simulate-optimizer-probe-publication-boundary.json`
 * are the
