...
| ORACLE-017 | State tax | [`packages/engine/src/tax/stateTax.external.golden.test.ts`](../packages/engine/src/tax/stateTax.external.golden.test.ts) | MRS 2026 rate schedule — Maine's decoupled $15,700/$31,400 standard deduction (asserted as pack parameters), with each worksheet an explicit taxable-income evaluation of the published schedule: the 5.8%/6.75%/7.15% bracket stack and the 2% high-income surcharge modeled as a 9.15% top bracket (cases at $1.2M single / $1.6M MFJ taxable). Maine's deduction phase-out (fully out at $177,250/$354,550 Maine AGI) and $5,300 personal exemption are documented simplifications outside the asserted subset. |
