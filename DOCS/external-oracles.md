...
| ORACLE-011/012 | Optimizer / full plan | [`packages/engine/src/projection/oracle011012.external.characterization.test.ts`](../packages/engine/src/projection/oracle011012.external.characterization.test.ts) | Owl (pinned commit) as a directional Roth-conversion benchmark with exact-ledger non-regression; hand worksheet for a five-year RMD-start bridge (Pub 590-B divisors + 2026 Medicare premium). |
