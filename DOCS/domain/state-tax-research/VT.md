...
exemption at federal AGI of $55,000 or less for single, MFS, HOH, and
surviving-spouse filers; a partial exclusion applies above $55,000 and below
$65,000, with none at or above $65,000. For MFJ, the corresponding thresholds
are $70,000 and $80,000. Modeled as `taxesSocialSecurity: true` (the federally
...
- Social Security exemption (full at or below $55k federal AGI for
  single/MFS/HOH/surviving-spouse and $70k for MFJ, phasing out over the next
  $10k) simplified to fully taxed — overstates VT tax for many retirees.
