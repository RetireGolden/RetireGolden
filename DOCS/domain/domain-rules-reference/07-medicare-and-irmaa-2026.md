...
- **Part D cost-sharing** (`usc-42-1395w-113-b-pl-117-169-part-d-penalty-and-cost-sharing`, outOfScope): Part D late-enrollment penalty and insulin copayment ceiling are not modeled as runtime figures. CMS Final CY 2026 Part D Redesign Program Instructions publish the **CY 2026 annual out-of-pocket threshold at $2,100** (not the 2025 $2,000 amount); that dollar is pinned on `ParameterPack.medicare.partDAnnualOutOfPocketThreshold` without creating drug-spend inputs.
- **IRMAA redetermination evidence** (`cfr-20-418-1205-1230-irmaa-life-change-redetermination`, outOfScope): the regulation's life-changing-event evidence and redetermination request mechanics are not modeled beyond the planning-grade SSA-44 election surface. **POMS HI 01120.005 A** defines a significant MAGI reduction as a decrease that reduces or eliminates IRMAA (crossing into a lower charge band); two MAGIs in the same band are not significant under that limb alone, and qualifying LCE + request/evidence + SSA determination remain required — not automatic appeal approval.
