...
- **Gift and estate transfer tax** (`irc-2503-b-annual-gift-exclusion-not-modeled`, `irc-529-five-year-gift-election-not-modeled`, `irc-2010-c-3-basic-exclusion-amount-not-modeled`, `irc-2010-c-5-dsue-portability-election-not-modeled`, outOfScope): chapter 12 gift tax and chapter 11 estate-tax exclusion/portability mechanics are not computed. Authority pins for 2026 live on `ParameterPack.transferTax`: **annual gift exclusion $19,000** per donee (Rev. Proc. 2025-32 §4.42(1); $38,000 only under correct gift-splitting / independent-gift distinction — not automatic doubling; do not relabel 2024 $18,000/$36,000 as 2026) and **basic exclusion $15,000,000** (IRC 2010(c)(3)(A); not an automatic $30M without portability/spouse conditions). A valid five-year 529 front-load of $95,000 apportions $19,000/year; without the election the whole amount is not an annual exclusion, and another same-year gift is not covered by a fresh $19,000.
