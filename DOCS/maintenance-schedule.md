...
| Per-state income tax (brackets, deductions, exclusions, SS treatment) | State revenue depts; PolicyEngine-US; Tax Foundation cross-check | Annual, **plus a January staleness sweep** against Tax Foundation's "State Tax Changes Taking Effect January 1" — states on legislated ramps (GA, IN, MS, MT, NE, NC, OK as of 2026) go stale mid-cycle and must never be held forward (lesson from the 2026-07 sweep) | `params/state/`, [domain/state-tax-research/](domain/state-tax-research/) |
