...
| SPIA payout-rate planning table (annuitization sweep + purchase candidates) | Public quote aggregators (Blueprint-Income-style marketplaces, insurer calculators) | Rates move with yields; refresh annually with the packs | `engine/decisions/spiaQuotes.ts`, domain rules §19 |
