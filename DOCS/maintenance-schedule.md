...
| Per-state income tax (brackets, deductions, exclusions, SS treatment) | State revenue depts; PolicyEngine-US; Tax Foundation cross-check | Annual, **plus a January staleness sweep** against Tax Foundation's "State Tax Changes Taking Effect January 1" — states on legislated ramps (GA, IN, MS, MT, NE, NC, OK, SC as of 2026) go stale mid-cycle and must never be held forward (lesson from the 2026-07 sweep). The TF Jan-1 article misses **post-January enactments** (SC H.4216, signed 2026-03-30, rewrote TY2026 retroactively) — the sweep must also check state DOR news pages for the current tax year | `params/state/`, [domain/state-tax-research/](domain/state-tax-research/) |
