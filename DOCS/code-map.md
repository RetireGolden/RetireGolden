...
| `testing/` | Test fixtures and deterministic doubles (`planFixtures.ts`, `money.ts`, `flatTax.ts`) consumed by the planner-UI suites, exported as `@retiregolden/engine/testing/*` |
