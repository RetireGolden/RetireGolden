...
This puts the settled 1951-1958 cohort on applicable age 72, moving the attain year to 2027 and the required beginning date into 2028, so a 2028 death is no longer unambiguously before the RBD — the worksheet's first wrong reading.
