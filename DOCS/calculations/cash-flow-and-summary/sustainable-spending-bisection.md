...
Midpoint `$65,000` is infeasible → `[60,000,65,000]`; `$62,500` feasible → `[62,500,65,000]`; integer midpoint `$63,750` infeasible → `[62,500,63,750]`; `$63,125` infeasible → `[62,500,63,125]`. Width `$625<=1,000`; feasible lower bound is `$62,500`.

## Expected

`maxBaseAnnual=$62,500`, `converged=true`, tolerance exact dollars for integer probes.
