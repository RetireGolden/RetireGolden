...
feeds: `projection-summary-fi-age`, `projection-summary-coast-fire-number`. This quantity reads `spending-total-annual`, `tax-total-annual` and `tax-penalties-annual` (its Inputs); it does not feed them.
