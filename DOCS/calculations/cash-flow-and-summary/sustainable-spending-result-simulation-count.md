...
| Infeasible-seed case | 10,000 infeasible; zero probed | dollars/year / state |
...
Infeasible-seed case: the seed is probe 1 and the required zero-spending probe is probe 2, so the count is `2`.
