...
RUN  v5.0.0 C:/TEMP/rg-rehearse2/packages/engine
 ...
 ❯ src/projection/simulate.evidence.test.ts (3 tests | 1 failed) 40ms
 ...
 Test Files  1 failed (1)
  ...
  Transform  transforming modules took 2.14s · 43% of tracked time, re-done on every run
...
+ false
 ...
 ❯ expectWithin src/projection/simulate.evidence.test.ts:33:5
     ...
     34| }
     35|
 ❯ src/projection/simulate.evidence.test.ts:154:7
