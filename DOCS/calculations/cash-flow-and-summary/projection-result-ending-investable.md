...
Exact value: `$487,250.125`. Fixture tolerance: absolute `$0.005`, because the copied ledger dollar is represented in binary floating point. An empty `years` array produces exactly `$0`.
