...
Case (a) required/target/ideal/excess shortfalls are `$0/$20/$20/$10`. Case (b) required/target/ideal/excess shortfalls are `$3/$43/$20/$10`. Expected tolerance is absolute `1e-12` dollars because only subtraction, min, and max occur.
