...
Household liquid balance is `$50,000`; total eligible ladder cost is `$200,000`.

## Arithmetic

A and C are eligible; B is excluded because its gap is already covered. `totalCost=$120,000+$80,000=$200,000`. The single household threshold is `0.50*$200,000=$100,000`, and `$50,000<$100,000`, so the gap is reported. `annualTotal=$18,000+$12,000=$30,000/year`.
...
- Incorrectly applying the household `$50,000` balance separately to each claimant's 50% threshold includes A (`$50,000<$60,000`) but excludes C (`$50,000` is not less than `$40,000`), giving only `$120,000.00` cost and `$18,000.00/year`.
