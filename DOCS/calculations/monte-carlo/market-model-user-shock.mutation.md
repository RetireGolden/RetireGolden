...
```
 ...
 ❯ src/montecarlo/marketModels.evidence.test.ts (13 tests | 5 failed) 10ms
   ❯ market-model-empirical-history — Empirical historical shock, centered or raw (1)
     × centered shock 2 and raw shock 10; ledger returns 8% and 16% 3ms
   ...
   ❯ market-model-user-shock — One-year additive user shock on a lognormal base (1)
     × years 1 and 3 are 0 and year 2 is −20 1ms

 Test Files  1 failed (1)
      Tests  5 failed | 8 passed (13)

(node:44964) Warning: The 'NO_COLOR' env is ignored due to the 'FORCE_COLOR' env being set.
(Use `node --trace-warnings ...` to show where the warning was created)
(node:20884) Warning: The 'NO_COLOR' env is ignored due to the 'FORCE_COLOR' env being set.
(Use `node --trace-warnings ...` to show where the warning was created)
...
+   -20,
 ...
 ❯ src/montecarlo/marketModels.evidence.test.ts:499:35
    497|         model.generatePath(scriptedRng({ normals: [0, 0, 0, 0, 0, 0] }…
    498|       )
    499|       expect(path.returnShockPct).toEqual(example.expected.returnShock…
       |                                   ^
    500|     })
    501|   },
