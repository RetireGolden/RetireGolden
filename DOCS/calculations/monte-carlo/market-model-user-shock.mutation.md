...
```
 ...
 ❯ src/montecarlo/marketModels.evidence.test.ts (16 tests | 1 failed) 10ms
...
+   -20,
 ...
 ❯ src/montecarlo/marketModels.evidence.test.ts:682:35
    680|         model.generatePath(scriptedRng({ normals: [0, 0, 0, 0, 0, 0] }…
    681|       )
    682|       expect(path.returnShockPct).toEqual(example.expected.returnShock…
       |                                   ^
    683|     })
    684|   },
