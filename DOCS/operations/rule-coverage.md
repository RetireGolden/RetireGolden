...
| projection/internal/annualForcedDistributionQcdAndRetirementActionsPhase.ts | 2026-09-12 | Effectful forced-distribution, QCD, SEPP, inherited-account and retirement-action phase composes the registered planners. Election-year owner-RMD reconciliation now suppresses replaced beneficiary draws before tax characterization, preserves immutable trigger evidence, applies accepted owner draws, publishes structured owner obligations and routes unsatisfied amounts to the existing RMD gate and section 4974 obligation contract. Caller-owned balance, basis, cash-flow and journal mutations retain explicit ordering. Mixed-year tax chronology and broader transactional composition remain partial; module linkage does not assert passing validation. |
...
| projection/internal/annualOwnedAccountDrawsPhase.ts | 2026-09-12 | Election-year spouse-owner requirement and death-year zero requirement are pinned to the c3 owner/death-year records. The planner delegates applicable-age and Uniform Lifetime arithmetic, subtracts accepted qualifying actuals, limits cash to the live balance and preserves the beneficiary trigger independently. Caller evidence acceptance, physical settlement, structured obligation publication and mixed-year chronology belong to separate adapters/coordinators; the complete transaction and residual-discharge sweep remains partial. No passing test or full original acceptance is claimed. |
...
| tax/stateTax.ts | 2026-09-12 | Both de-code-30-1108-standard-deduction and de-pit-est-2026-qss-standard-deduction-joint-mapper name computeStateTaxableIncome in this file and age65StandardDeductionAddition in params/index.ts; the first covers Delaware single/MFJ basic-plus-age, while the second discloses the QSS-to-joint standard-deduction approximation; other Delaware return limbs remain outside those records. oh-rev-code-5747-02-a-3-c-2026-nonbusiness-rate-schedule names bracketTax for the Ohio TY2026 cumulative base above $26,050; prorateParams scales that base under the existing model convention for part-year residency, not a legal part-year claim, and consumers do not get pins. me-mrs-36-5122-2-m2-m3-2026-pension-deduction names computeStateTaxableIncome and retirementExclusion for Maine's $49,824 TY2026 flat cap without SS offset, military separation, M-3 phaseout, or plan qualification. iowa-code-422-7-8-social-security-subtraction, il-ita-203-a-2-L-social-security-subtraction, nj-njit12-social-security-exclusion, ny-dtf-social-security-subtraction, and pa-pit-social-security-not-compensation name computeStateTaxableIncome enforcers only (with/without-benefits base-delta discriminators, not whole-return figures). ga-code-48-7-27-retirement-and-social-security-exclusion gained a Social-Security relational fixture limb here; md-tax-10-209-pension-exclusion's gross-SS relational limb remains in stateTax.approximation.test.ts. Existing law records name this file; residuals include KY aggregate MFJ deduction convention without spouse-allocation record, DC August emergency statutory-conformity timing unresolved, ME modeled Maine-AGI proxy / personal exemption / blindness / part-year month approximation, non-ME gaps unchanged, and stateParamsFor historical fallback: years before the earliest published pack receive that earliest pack with no validity marker so computeStateTaxYearTotal consumes a current-pack approximation without exposing whether the pack is exact. The Iowa alternate/minimum comparison is now routed to its registered leaf. Proved-zero relief bounds can omit immaterial CT/WI exemption or Iowa alternate-tax warnings; material missing worksheet bases still remain incomplete. Oregon pension-credit metadata is unnecessary only when the complete characterized ledger proves no qualifying pension. Illinois missing exemption counts below the versioned AGI cutoff and Vermont missing deduction/exemption counts are likewise immaterial only under the proved-zero pre-exemption bound with an absent or nonnegative standard-deduction override. Illinois missing AGI remains disclosed. Vermont minimum-tax metadata warnings are omitted only when known federal AGI is at or below the known versioned minimum-tax threshold; unknown or above-threshold AGI retains the warning. These guards preserve unrelated missing-source warnings and do not infer missing facts as zero |
...
Committed ledger generated at 2026-09-23T22:50:50.754Z over 1545 authority entries (0 fetched live, 433 from cache).

5 serious, 6 advisory, 1534 verify clean. Serious verdicts are dispositioned through the rules:due re-verification queue,
