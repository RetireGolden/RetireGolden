...
import type { InsightAction, InsightCard, InsightImpact } from '../insights/types'
import { evaluateCandidate, type EvaluateCandidateOptions } from './evaluateCandidate'
import type { DecisionCandidate, DecisionContext, ExactDecisionEvaluation } from './types'
