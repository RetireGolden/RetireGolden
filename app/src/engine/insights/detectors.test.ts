...
import { applyScenarioPatch, compareScenarios } from '../scenarios/scenarios'
...
import { assetLocationGenerator, probabilityBandSpendingGuardrailGenerator } from '../decisions/generators'
import { createDecisionContext, evaluateCandidate } from '../decisions/evaluateCandidate'
import type { DecisionContext } from '../decisions/types'
import { assetLocationPlan, noTraditionalPlan, simOptions } from '../decisions/decisionFixtures'
import { runSpendingSolveRequest } from '../../optimize/runSpendingSolve'
import type { Plan } from '../model/plan'
import type { DetectorContext, InsightCard } from './types'
