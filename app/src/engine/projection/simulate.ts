...
import type { Account, AssetAllocationPolicy, Person, Plan } from '../model/plan'
import { ASSET_CLASS_IDS, stateForYear, stateResidencySegmentsForYear } from '../model/plan'
import {
  accountAllocation,
  blendedTaxableYield,
  driftWeights,
  ...
  targetWeightsAt,
} from '../allocation/assetClasses'
import { packForYear, LATEST_PACK_YEAR, hecmPrincipalLimitFactorPct, EMBEDDED_REAL_YIELD_CURVE } from '../params'
import { annuityExclusionMultiple, annuityPayoutForm, annuityPayoutFraction } from './annuityForms'
import { buildLadder, ladderRealFlowsAtOffset, ladderRemainingFace, type LadderRung } from '../ladder/ladderMath'
import { stateParamsFor } from '../params/state'
import type { ParameterPack } from '../params/types'
import { requiredMinimumDistribution } from '../rmd/rmd'
import { claimFactor, spousalBenefitFactor, type ClaimAge } from '../../socialSecurity/claimFactor'
import { bestMaritalBenefit } from '../../socialSecurity/maritalBenefits'
import { capAuxiliaryForFamilyMaximum, claimAgeTotalMonths } from '../../socialSecurity/familyMaximum'
import { sizeRothConversion } from '../strategies/rothConversion'
import { splitRothWithdrawal, type RothBasisState } from '../strategies/rothBasis'
import { seppActive, seppAnnualAmount } from '../strategies/sepp'
import { inheritedForcedAmount } from '../strategies/inheritedIra'
import {
...
} from '../strategies/accountEligibility'
import { openIraProRataYear, splitIraDistribution, type IraProRataYear } from '../strategies/iraBasis'
import { propertySaleTax } from '../tax/propertySale'
import { effectiveBirthYear, fraForBirthYear, fraTotalMonths, survivorFraForBirthYear } from '../../socialSecurity/nra'
import {
...
import { survivorBenefitMonthly } from '../../socialSecurity/survivorBenefit'
import { inSsdiWindow, ssdiMonthlyBenefit, ssdiSuspendedBySga } from '../../socialSecurity/disability'
import { attributeShortfall, splitAnnualSpendingLayers } from '../spending/layers'
import { ABW_DEFAULTS, abwAnnualPayment, abwExpectedRealReturnPct } from '../spending/abw'
import { jointSurvivalPercentileAge, survivalPercentileAge } from '../montecarlo/survival'
import {
  nextBalanceGuardrailMultiplier,
  nextGuardrailMultiplier,
  type GuardrailAction,
  type GuardrailPolicy,
} from '../spending/guardrails'
import { createGoalScheduler, toSchedulableGoal, type GoalScheduler } from '../spending/flexibleGoals'
import { acaNetAnnualPremiumByMonth } from '../tax/aca'
import { applyCapitalLossCarryforward, computeFederalTax, taxableSocialSecurity } from '../tax/federalTax'
