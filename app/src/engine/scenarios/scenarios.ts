...
import type { Plan, Scenario } from '../model/plan'
import { parsePlan, type ParsePlanResult } from '../model/plan'
import type { MarketModelConfig } from '../montecarlo/marketModels'
import { createMarketModel } from '../montecarlo/marketModels'
import { aggregateMonteCarlo, runMonteCarloPaths } from '../montecarlo/run'
import { summarizeProjection, type ProjectionSummary } from '../projection/compare'
import { simulatePlan, type SimulateOptions } from '../projection/simulate'
import type { TaxCalculator } from '../projection/types'
