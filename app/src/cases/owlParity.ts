...
import { optimizePlan, evaluateExactLedgerSchedule, withOptimizedConversions } from '../engine/projection/optimizePlan'
import { DEFAULT_OPTIMIZE_CONVERGENCE_ITERATIONS, DEFAULT_OPTIMIZE_SEARCH_BUDGET } from '../optimize/runOptimize'
import { summarizeProjection, type ProjectionSummary } from '../engine/projection/compare'
import { simulatePlan, type SimulateOptions } from '../engine/projection/simulate'
import type { ProjectionResult } from '../engine/projection/types'
import { EXAMPLE_FIXED_YEAR, exampleEntityId, exampleFixedNow, exampleIdFactory } from '../planner/examples/buildContext'
