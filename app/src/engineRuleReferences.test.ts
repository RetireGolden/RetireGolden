/**
 * retiregolden-web hosts planner-ui and case harnesses; it must not restate law,
 * so a rule id it mentions must exist in the registry, and it may only consume
 * the engine through its public subpaths.
 *
